...
xilinx.com:user:axis_sigmoid:1.0\
...
\
  ...
  # Create instance: axis_sigmoid_0, and set properties
  set axis_sigmoid_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:axis_sigmoid:1.0 axis_sigmoid_0 ]
  ...
  connect_bd_intf_net -intf_net axi_dma_0_M_AXIS_MM2S [get_bd_intf_pins axis_sigmoid_0/s_axis] [get_bd_intf_pins axi_dma_0/M_AXIS_MM2S]
  ...
  connect_bd_intf_net -intf_net axis_sigmoid_0_m_axis [get_bd_intf_pins axis_sigmoid_0/m_axis] [get_bd_intf_pins axi_dma_0/S_AXIS_S2MM]
  ...
  [get_bd_pins axis_sigmoid_0/aclk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N  [get_bd_pins processing_system7_0/FCLK_RESET0_N] \
  [get_bd_pins rst_ps7_0_50M/ext_reset_in]
  connect_bd_net -net rst_ps7_0_25M_peripheral_aresetn  [get_bd_pins rst_ps7_0_50M/peripheral_aresetn] \
  ...
  [get_bd_pins axis_sigmoid_0/aresetn]
  ...
  set_property PFM_NAME {xilinx:zybo-z7-10:name:0.0} [get_files [current_bd_design].bd]
  set_property PFM.CLOCK {FCLK_CLK0 {id "0" is_default "true" proc_sys_reset "" status "fixed" freq_hz "25000000"}} [get_bd_cells /processing_system7_0]
